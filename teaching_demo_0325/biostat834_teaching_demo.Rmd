...
working_dir <- "~/irena/biostat_834_demo/0325_teaching_demo/"
aid_data <- read.csv(paste0(working_dir, "biostat_834_dataset.csv"))
```

```{r run_lmm}
aid_lme <- lmer(
  estimated_incidence_num ~ dah_19_in_mill  + year + (1 + year|iso3c), 
  data=aid_data,
...
bayes_lmm <- readRDS(paste0(working_dir,"/bayes_lmm_example.RDS"))
```
